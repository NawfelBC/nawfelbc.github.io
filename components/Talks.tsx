...
const Talks = () => {
  return (
    <div id="talks" className="border-b border-neutral-900 pb-4">
        ...
        <div className="flex flex-wrap pb-4">
            ...
            >
                ...
                <div className={cn('text-center pt-4 tracking-wide', MontserratFont.className)} >
                    Data Vault 2.0 with dbt
                </div>
                <div className={cn('text-center tracking-wide', MontserratFont.className)} >
